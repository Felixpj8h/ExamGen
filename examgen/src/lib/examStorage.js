...
export function loadStoredExamBundle() {
  try {
...
export function loadStoredExamId() {
  try {
...
export function setMockExamLocation() {
  if (window.location.hash !== '#mock-exam') {
    window.history.pushState(null, '', '#mock-exam');
  }
}

export function withExamAssetUrls(bundle, examId) {
